...
Date: 2016-10-31 20:49
Author: egongu90
Category: Various
Tags: analysis, ansible, code, conditional, logic, opinion, skip, syntax, True, when, with_first_found
Slug: to-conditional-or-to-skip-that-is-the-ansible-question
Status: published
...
To\_skip method is simpler to read and unified in a single task,
to\_conditional is created within two tasks.  
To\_conditional method takes longer to be executed as it has to check
the existence of a file and then evaluate a conditional.

You may think that to\_skip method is better than to\_conditional
...
to\_conditional method because when I'm deploying something new, I want
to know what is executed and what not. In to\_skip method you don't know
because there is no output provided from the task(not really true) but
in to\_conditional method it clearly says Skipping.
